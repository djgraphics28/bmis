...
<div class="wrapper" id="app">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
      ...
      <span class="logo-mini" style="font-size:14px!important;"><b>BIMS</b></span>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{ strpos(Request::url(), 'admin-member') == true ? 'active' : '' }}">
    ...
    <!-- /.sidebar -->
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2021 <a href="#">Barangay Information Management System</a>.</strong> All rights
            reserved.
        </footer>
