                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="row col-md-offset-1">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" name="gender" value="Female" class="minimal" checked="{{ isset($user) && $value->user_gender == 'Female' ? 'false' : 'false' }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="user_type" id="user_type" class="form-control select2"  style="width: 100%;" required>
                                            ...
                                            @foreach ($usertype as $item)
                                                <option value="<?= $item->id ?>" {{ isset($user) && $value->user_type == $item->id ? 'selected' : '' }}><?= $item->usertype ?></option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
